...
$suppliers = [
    ...
    'Frais Import' => [
        ...
        'products' => [
            ...
            ['name' => 'Essuie-mains gaufres 450F', 'price' => 3.758],
            ['name' => 'Tranche chèvre IQF 500g', 'price' => 7.94],
            ['name' => 'Tranche Mozzarella IQF 500g', 'price' => 7.26],
            ['name' => 'Frites 9/9 A4 2.5kg', 'price' => 2.39],
            ['name' => 'Coulant chocolat Ø65 x20', 'price' => 2.5],
            ['name' => 'Mozzarella cossettes 2.5kg', 'price' => 2.5],
            ['name' => 'Chorizo tranché 500g', 'price' => 7.8],
            ['name' => 'Crème cuisson 18% Président', 'price' => 5],
            ['name' => 'Emmental râpé 1kg', 'price' => 7.55],
            ['name' => 'Lardon fumé 1kg', 'price' => 7.8],
            ['name' => 'Épaule cuite DD 5kg', 'price' => 6.95],
            ['name' => 'Cheddar burger 88tr', 'price' => 11.95],
            ['name' => 'Reblochon tranche 500g', 'price' => 13.98],
            ['name' => 'Chute saumon fumé 1kg', 'price' => 18.47],
            ['name' => 'Pulpe d\'ail pot 1kg', 'price' => 4.25],
            ['name' => 'Sarcive volaille 2kg', 'price' => 21.95],
